...
var S3Image = /** @class */ (function (_super) {
    ...
    S3Image.prototype.getImageSource = function (key, level, track) {
        var _this = this;
        ...
        storage_1.default.get(key, { level: level ? level : 'public', track: track })
            .then(function (url) {
            _this.setState({
                src: url
            });
    ...
    S3Image.prototype.load = function () {
        var _a = this.props, imgKey = _a.imgKey, path = _a.path, body = _a.body, contentType = _a.contentType, level = _a.level, track = _a.track;
        if (!imgKey && !path) {
    ...
    S3Image.prototype.handlePick = function (data) {
        ...
        var _a = this.props, imgKey = _a.imgKey, level = _a.level, fileToKey = _a.fileToKey, track = _a.track;
