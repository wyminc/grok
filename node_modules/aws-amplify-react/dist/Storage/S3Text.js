...
var S3Text = /** @class */ (function (_super) {
    ...
    S3Text.prototype.getText = function (key, level, track) {
        var _this = this;
        ...
        storage_1.default.get(key, { download: true, level: level ? level : 'public', track: track })
            .then(function (data) {
            logger.debug(data);
    ...
    S3Text.prototype.load = function () {
        var _a = this.props, path = _a.path, textKey = _a.textKey, body = _a.body, contentType = _a.contentType, level = _a.level, track = _a.track;
        if (!textKey && !path) {
    ...
    S3Text.prototype.handlePick = function (data) {
        ...
        var _a = this.props, textKey = _a.textKey, level = _a.level, fileToKey = _a.fileToKey, track = _a.track;
