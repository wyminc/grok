    ...
    SelectMFAType.prototype.selectView = function (theme) {
        ...
        return (React.createElement(Amplify_UI_Components_React_1.FormSection, { theme: theme },
            this.state.showToast && this.state.selectMessage &&
                React.createElement(Amplify_UI_Components_React_1.Toast, { onClose: function () { return _this.setState({ showToast: false }); } }, core_1.I18n.get(this.state.selectMessage)),
            ...
            React.createElement(Amplify_UI_Components_React_1.SectionFooter, null,
